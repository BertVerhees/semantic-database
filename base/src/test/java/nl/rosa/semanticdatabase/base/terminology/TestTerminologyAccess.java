...
public class TestTerminologyAccess implements TerminologyAccess {
    ...
    public static final CodePhrase RELATIONS = new CodePhrase(new TerminologyId("test"), "family_code");
    public static final CodePhrase SETTING = new CodePhrase(new TerminologyId("test"), "setting_code");
    ...
    public static final CodePhrase CHANGE = new CodePhrase(TestTerminologyID.SNOMEDCT, 
            "changeTypeCode");
    public static final CodePhrase ACTIVE = new CodePhrase(new TerminologyId("test"), "active");
    public static final CodePhrase CREATION = new CodePhrase(new TerminologyId("openehr"), "249");
    public static final CodePhrase PERSISTENT = new CodePhrase(new TerminologyId("test"), "persistent");
    public static final CodePhrase EVENT = new CodePhrase(new TerminologyId("test"), "event");
